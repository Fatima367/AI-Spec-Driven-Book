...
from models import UserQuery, ChatResponse as ChatResponseModel, Citation, DocumentChunk
            ...
            for scored_point in search_result.points:
                if scored_point.payload:
                    ...
                    citations.append(Citation(
                        doc_id=chunk.doc_id or chunk.chapter_title, # Use doc_id if available, otherwise chapter_title
                        chunk_id=chunk.chunk_id or str(scored_point.id), # Use chunk_id if available, otherwise point id
